  ...
  <div class="tool-card selected-card" v-else>
    <div class="tool-card-content">
      ...
      <div class="card-top">
        ...
        <div class="tool-dist-name selected">
      ...
      <div class="card-bottom selected">
        <h4>{{description}}</h4>
      </div>

      <div class="card-lower-icons">
        <div class="icons">
          <a href=""><img src="/src/assets/svg/icons/flat-color-icons_like.svg" alt=""></a>
    ...
    .card-top
      ...
      .tool-dist-name
        ...
        h1
          ...
          font-weight: normal
        h3
          color: $font-color-unselected-card-cost
    .card-bottom
      h4
        font-weight: normal
        font-size: 16px
        ...
        line-height: 30px
        color: $font-color-unselected-card-text
    .card-lower-icons
      display: flex
      align-items: center
    ...
    .card-top
      .selected
        ...
        h1
          color: #E9EAEA
        h3
          color: $font-color-selected-card-cost
    .card-bottom
      padding-bottom: 30px
    .selected
      h4
